...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Prepare your child for NAPLAN with expert online tutoring aligned to the Australian Curriculum. Targeted practice for Year 3, Year 5 & Year 7 in Maths, Reading, Writing & Language Conventions.",
    url: "https://tutorexel.com/au/naplan-preparation",
    siteName: "TutorExel",
    locale: "en",
    type: "website",
...
export default function NaplanPreparationPage() {
  const breadcrumbSchema = createBreadcrumbSchema([
    { name: "Home", url: "https://tutorexel.com/au" },
    { name: "NAPLAN Preparation", url: "https://tutorexel.com/au/naplan-preparation" },
  ]);
        ...
        <div className="container">
          <div className="naplan-links__content">
            ...
            <div className="naplan-links__grid">
              <Link href="/au/subjects/year-3/maths" className="naplan-links__link">Year 3 Maths</Link>
              <Link href="/au/subjects/year-3/english" className="naplan-links__link">Year 3 English</Link>
              <Link href="/au/subjects/year-5/maths" className="naplan-links__link">Year 5 Maths</Link>
              <Link href="/au/subjects/year-5/english" className="naplan-links__link">Year 5 English</Link>
              <Link href="/au/subjects/year-7/maths" className="naplan-links__link">Year 7 Maths</Link>
              <Link href="/au/subjects/year-7/english" className="naplan-links__link">Year 7 English</Link>
              <Link href="/au/free-assessment" className="naplan-links__link">Free Assessment</Link>
              <Link href="/au/pricing" className="naplan-links__link">Pricing</Link>
              <Link href="/au/blog/why-national-assessments-matter-naplan-icas" className="naplan-links__link">Why NAPLAN Matters</Link>
              <Link href="/au/blog/stress-to-strategy-naplan-icas-prep-saves-time" className="naplan-links__link">NAPLAN Prep Strategy</Link>
            </div>
          </div>
        </div>
      </section>
