...
export async function generateMetadata({
  ...
  const url = `https://tutorexel.com/au/online-tutoring/${city.slug}`;
...
export default async function CityPage({
  ...
  const breadcrumbSchema = createBreadcrumbSchema([
    ...
    { name: "Online Tutoring", url: "https://tutorexel.com/au/online-tutoring" },
    {
      name: city.name,
      url: `https://tutorexel.com/au/online-tutoring/${city.slug}`,
    },
  ]);
        ...
        <div className="container">
          ...
          <div className="city-offer__grid">
            <div className="city-offer__card">
              ...
              <Link href="/au/subjects" className="city-offer__card-btn">
                View Maths Programs
              </Link>
            </div>
            ...
            <div className="city-offer__card">
              ...
              <Link href="/au/naplan-preparation" className="city-offer__card-btn">
                NAPLAN Prep Details
              </Link>
            </div>
          </div>
        ...
        <div className="container">
          <div className="city-links__content">
            ...
            <div className="city-links__grid">
              <Link href="/au/subjects" className="city-links__link">All Subjects</Link>
              <Link href="/au/pricing" className="city-links__link">Pricing</Link>
              <Link href="/au/free-assessment" className="city-links__link">Free Assessment</Link>
              <Link href="/au/naplan-preparation" className="city-links__link">NAPLAN Preparation</Link>
              <Link href="/au/online-tutoring" className="city-links__link">All Cities</Link>
              {cities
                .filter((c) => c.slug !== city.slug)
                .map((c) => (
                  <Link
                    key={c.slug}
                    href={`/au/online-tutoring/${c.slug}`}
