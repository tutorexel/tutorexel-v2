...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Comprehensive research report on the Australian tutoring industry in 2026. Market size, trends, parent preferences, online vs in-person data, and NAPLAN impact analysis.",
    url: "https://tutorexel.com/au/research/australian-tutoring-report-2026",
    siteName: "TutorExel",
    locale: "en",
    type: "article",
  },
...
export default function AustralianTutoringReport2026Page() {
  const breadcrumbSchema = createBreadcrumbSchema([
    ...
    { name: "Research", url: "https://tutorexel.com/au/research" },
    { name: "2026 Australian Tutoring Report", url: "https://tutorexel.com/au/research/australian-tutoring-report-2026" },
  ]);
