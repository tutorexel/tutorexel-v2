...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title: metaTitle,
      description: metaDescription,
      url: `https://tutorexel.com/us/blog/${post.slug}`,
      siteName: "TutorExel",
      locale: "en",
      type: "article",
...
export default async function UsBlogPostPage({ params }: Props) {
  ...
  const blogBreadcrumbSchema = createBreadcrumbSchema([
    { name: "Home", url: "https://tutorexel.com/us" },
    { name: "Learning Hub", url: "https://tutorexel.com/us/blog" },
    { name: post.title, url: `https://tutorexel.com/us/blog/${post.slug}` },
  ]);
