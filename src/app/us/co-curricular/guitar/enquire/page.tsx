        ...
        <div className="container">
          <div className="cc-booking__widget">
            <iframe
              ...
              title="Book a free guitar trial lesson"
              loading="lazy"
              scrolling="no"
            />
          </div>
